...
try {
    ...
    $partial_macth = "%{$keyword}%";

    $stmt_select->bindValue(':keyword', $partial_macth, PDO::PARAM_STR);
                ...
                <div class="books-ui">
                    <div>
                        <a href="read.php?order=desc&keyword=<?= $keyword ?>">
                            <img src="images/desc.png" alt="降順に並べ換え" class="sort-img">
                        </a>
                        <a href="read.php?order=asc&keyword=<?= $keyword ?>">
                            <img src="images/asc.png" alt="昇順に並べ換え" class="sort-img">
                        </a>
                        <form action="read.php" method="get" class="search-form">
                            <input type="hidden" name="order" value="<?= $order ?>">
                            <input type="text" class="search-box" placeholder="商品名で検索" name="keyword" value="<?= $keyword ?>"><!--なぜここでphpが実装されているかわからない。<?= $keyword ?>のおかげ？-->
                        </form>
                    </div>
